-- =============================================================
-- 086_doc_type_cheque.sql
-- Novo document_type: 'cheque' (pagamento em cheque — o cheque como DOCUMENTO
-- da conta a pagar, distinto do payment_method 'cheque' que descreve a forma).
-- Estende o CHECK de financial_account_control.document_type.
--
-- Projeto: pagamentos | Data: 2026-07-17
--
-- Tipo SELECIONÁVEL no cadastro manual (ContaForm) e no filtro de /consulta —
-- NÃO é auto-classificado pela palavra "cheque" no assunto/corpo (que já é uma
-- forma de pagamento; classificar por ela geraria falso positivo). O extractor
-- só o emite se o rótulo explícito casar (_DOC_TYPE_NORM em extract_pdf.py).
--
