...
const repository = {
  async findAll(params: {
    ...
    const fallback = { column: 'account_code', ascending: true, nullsFirst: false };

    return applyOrder(query, sorted, fallback, 'chart_account_id').range(params.from, params.to);
  },
