...
// Stub do lookup de empresas (o <select> "Empresa" carrega OTIMOTEX/LEBIANCO).
...
describe('ContaForm — Empresa', () => {
  it('cadastro: nasce no default OTIMOTEX e vai no payload mesmo sem o usuário tocar', async () => {
    const { onSubmit } = setup();
  ...
  it('falha no lookup não trava o lançamento — mantém a OTIMOTEX', async () => {
